...
const Avatar = memo(({ name }) => {
  ...
  return (
    <div className={`w-10 h-10 md:w-12 md:h-12 rounded-full ${colorClass} flex items-center justify-center text-white font-bold text-sm md:text-base border-2 border-[#EEC970] shadow-lg`}>
      {initials}
    </div>
  );
});
